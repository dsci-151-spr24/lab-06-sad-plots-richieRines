...
```{r eval = FALSE, fig.width = 10, fig.fullwidth = TRUE}
staff_long %>%
...
***I can make the color of the focus line (Part-Time Faculty) different from the others so that it pops out at the viewer more.***
...
staff_long %>%
  ...
  geom_line() +
  labs(
       title = "Part-Time Faculty Trend (1975-2011)",
    subtitle = "Compared to other Staff",
       color = "",   
           x = "",
           y = ""
  ) +
...
fisheries %>%
  ...
  labs(
    x = "Proportion",
    y = "",
    title = "Fishing Types in Different Countries"
  )
